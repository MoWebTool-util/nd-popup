...
describe('popup', function() {
  ...
  it('trigger selector', function() {
    var trigger = $('<div id="wrap"><a href="javascript:void(0)" class="trigger-element">Trigger</a></div>').appendTo(document.body);
    pop = new Popup({
  ...
  it('should be visible when element is generated by template', function() {
    pop = new Popup({
