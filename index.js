...
var Popup = Overlay.extend({
  ...
  _bindClick: function () {
    ...
    bindEvent('click', this.get('trigger'), function() {
  ...
  _bindFocus: function () {
    ...
    this.delegateEvents('mousedown', function() {
  ...
  _onRenderVisible: function (val, originVal) {
    ...
    var slide = effect.indexOf('slide') !== -1;
    var animConfig = {};
    ...
    if (fade || slide) {
      this.element.stop(true, true).animate(animConfig, this.get('duration'), function () {
